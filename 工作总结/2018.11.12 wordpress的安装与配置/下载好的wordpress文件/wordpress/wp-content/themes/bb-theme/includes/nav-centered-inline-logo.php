	...
	<div class="fl-page-header-wrap">
		<div class="fl-page-header-container <?php FLLayout::container_class(); ?>">
			<div class="fl-page-header-row <?php FLLayout::row_class(); ?>">
				<div class="fl-page-header-logo fl-inline-logo-<?php echo FLTheme::get_setting( 'fl-inline-logo-side' ); ?> col-sm-12" itemscope="itemscope" itemtype="https://schema.org/Organization">
