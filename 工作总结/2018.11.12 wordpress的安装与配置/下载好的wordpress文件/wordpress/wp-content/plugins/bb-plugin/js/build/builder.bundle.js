	...
	_createClass(UI, [{
		...
		value: function render() {
			return _react2.default.createElement(
				_react.Fragment,
				null,
				_react2.default.createElement(_inlineEditor2.default, null),
				_react2.default.createElement(_notifications.NotificationsManager, null)
			);
		}
	}]);
 ...
 *
 * NOTE: This is meant to work on layouts outside of the builder
 * (such as in the WordPress editor). Keep in mind that objects
 * such as FLBuilder might not be defined in those cases. The only
 * other builder object that will be available in those cases is
 * the FLBuilderSettingsConfig object.
 *
 * However, as of 2.1, there is still work to be done if we'd
 * like this to be fully functioning outside of the builder.
 * Currently it will work outside of the builder but doesn't
 * know how to save in those situations.
 *
 * @since 2.1
 * @class InlineEditor
 */
var InlineEditor = function (_Component) {
	_inherits(InlineEditor, _Component);

	function InlineEditor(props) {
		_classCallCheck(this, InlineEditor);

		var _this = _possibleConstructorReturn(this, (InlineEditor.__proto__ || Object.getPrototypeOf(InlineEditor)).call(this, props));

		var postId = _this.props.postId;

		_this.layoutClass = '.fl-builder-content-' + (postId ? postId : FLBuilderConfig.postId);
		return _this;
	}
	...
	_createClass(InlineEditor, [{
		...
		value: function setupHooks() {
			...
			var setupEditables = this.setupEditables.bind(this);
			var refreshEditables = this.refreshEditables.bind(this);
			var destroyEditables = this.destroyEditables.bind(this);
		...
		value: function setupEditables() {
			...
			if (content.length) {
				for (var key in editables) {
					var selector = '.fl-module[data-type="' + key + '"]:not(.fl-editable):not(.fl-node-global)';
					content.find(selector).each(function (index, module) {
						return _this2.setupEditable(jQuery(module));
					});
				}
			}
		}
		...
		value: function setupEditable(module) {
			...
			var nodeClass = '.fl-node-' + nodeId + ' ';
			var editorId = 'fl-inline-editor-' + nodeId;
			...
			var _loop = function _loop(key) {
				...
				var connection = form.find('#fl-field-' + key + ' .fl-field-connection-value');
				...
				tinymce.init({
					...
					plugins: _this3.getEditorPluginConfig(data.field.type),
					toolbar: _this3.getEditorToolbarConfig(data.field.type),
       ...
       */
		...
		value: function refreshEditables() {
			this.setupEditables();
			tinymce.editors.map(function (editor, i) {
		...
		value: function getEditorEventVars(target) {
			...
			return { editable: editable, module: module, editor: editor, field: field, nodeId: nodeId };
		}
	}, {
		key: 'onEditorInit',
		...
		value: function onEditorChange(e) {
			...
			var _getEditorEventVars = this.getEditorEventVars(target),
			    editable = _getEditorEventVars.editable,
			    editor = _getEditorEventVars.editor,
			    field = _getEditorEventVars.field,
			    nodeId = _getEditorEventVars.nodeId;

			var settings = jQuery('.fl-builder-settings[data-node="' + nodeId + '"]');
		...
		value: function onEditorFocus(e) {
			var _getEditorEventVars2 = this.getEditorEventVars(e.target.bodyElement),
			    ...
			    module = _getEditorEventVars2.module,
			    field = _getEditorEventVars2.field,
		...
		value: function onEditorMousedown(e) {
			var _getEditorEventVars4 = this.getEditorEventVars(e.target),
			    module = _getEditorEventVars4.module;
		...
		value: function onModuleMouseleave(e) {
		...
		value: function showModuleSettings(module) {
			...
			if (!settings.length) {
				FLBuilder._showModuleSettings({ type: type, nodeId: nodeId, parentId: parentId, global: global });
			}
		}
	}, {
		key: 'getSettingValue',
...
exports.NotificationsManager = undefined;
...
var renderHTML = function renderHTML(rawHTML) {
    return _react2.default.createElement("div", { dangerouslySetInnerHTML: { __html: rawHTML } });
};
...
var Post = function Post(props) {
    ...
    if ('string' === typeof props.url && props.url !== "") {
        ...
        post = _react2.default.createElement(
            'a',
            { className: 'fl-builder-ui-post', href: url, target: '_blank', rel: 'noopener' },
            ...
            _react2.default.createElement('div', { className: 'fl-builder-ui-post-content', dangerouslySetInnerHTML: html })
        );
    } else {
        post = _react2.default.createElement(
            'span',
...
var NotificationsPanel = function (_Component) {
    _inherits(NotificationsPanel, _Component);

    function NotificationsPanel(props) {
        _classCallCheck(this, NotificationsPanel);

        return _possibleConstructorReturn(this, (NotificationsPanel.__proto__ || Object.getPrototypeOf(NotificationsPanel)).call(this, props));
    }
    ...
    _createClass(NotificationsPanel, [{
        ...
        value: function getPosts(posts) {
            var view = void 0,
                renderedPosts = void 0,
                strings = FLBuilderStrings.notifications;
            if (posts.length > 0) {
                renderedPosts = posts.map(function (item) {
                    return _react2.default.createElement(
                        Post,
                        { key: item.id, title: renderHTML(item.title.rendered), date: item.date, url: item.meta._fl_notification[0] },
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'fl-nanoscroller', ref: this.setupScroller },
                    _react2.default.createElement(
                        'div',
...
var NotificationsManager = exports.NotificationsManager = function (_Component2) {
    ...
    _createClass(NotificationsManager, [{
        ...
        value: function render() {
            var _state = this.state,
                shouldShowNotifications = _state.shouldShowNotifications,
                posts = _state.posts;
            ...
            return _react2.default.createElement(
                _react.Fragment,
                null,
                shouldShowNotifications && _react2.default.createElement(NotificationsPanel, {
                    posts: posts })
            );
        }
    }]);
